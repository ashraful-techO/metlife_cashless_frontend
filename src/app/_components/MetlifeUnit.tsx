...
import { CreateSingleUser, MetlifeFilter, UserLists } from "@/components/organism/Metlife";
...
export const MetlifeUnit = () => {
	...
	return (
		<div className="mt-[-20px]">
			<div className="flex items-center gap-6">
				...
				<Menu placement="bottom">
					...
					<MenuList className="p-1 min-w-[130px] ">
						<MenuItem className="hover:bg-transparent" onClick={() => setCreateUserModal(true)}>
							Single Upload
						</MenuItem>
						<MenuItem className="hover:bg-transparent" onClick={() => setBulkUserModal(true)}>
							Bulk Upload
						</MenuItem>
					</MenuList>
				</Menu>
			...
			<UserLists data={tableData as any} loading={tableDataLoading} updateData={getTableData} />
